...
CREATE TABLE `questions` (
  ...
  KEY `quizname_idx` (`quizname`),
  CONSTRAINT `quizname` FOREIGN KEY (`quizname`) REFERENCES `quizes` (`quizname`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `questions` VALUES (30,'sum','1+1','-12+6','7+19'),(31,'mul','1*1','2*3','4*5');
